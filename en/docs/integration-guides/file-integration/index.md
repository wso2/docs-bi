...
* **Get Started:** [Develop File Integration](../../get-started/develop-file-integration.md)
* **File Sources:** Set up integrations for [Local Files Integration](file-sources/local-files-integration.md), [FTP](file-sources/ftp-integration.md), [FTPS](file-sources/ftps-integration.md), or [SFTP](file-sources/sftp-integration.md)
* **Guides:** [Sales Data Sync with FTP](../usecases/file-integration/sales-data-sync-with-ftp-file-integration.md), [Contractor Timesheet Validation](../usecases/file-integration/contractor-timesheet-validation.md)
