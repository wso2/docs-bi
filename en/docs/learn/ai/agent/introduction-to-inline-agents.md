...
5. Click the **Create New Integration** button to generate the integration project.
    ...
    <a href="{{base_path}}/assets/img/learn/introduction-to-inline-agents/inline-agent-step1.gif"><img src="{{base_path}}/assets/img/learn/introduction-to-inline-agents/inline-agent-create-a-new-integration-project.gif" alt="Create a new integration project" width="70%"></a>
...
3. Keep the default **Listener** and **Service base path** configurations, and click **Create**.
    ...
    <a href="{{base_path}}/assets/img/learn/introduction-to-inline-agents/inline-agent-step2.gif"><img src="{{base_path}}/assets/img/learn/introduction-to-inline-agents/inline-agent-create-a-graphql-service.gif" alt="Create a graphql service" width="70%"></a>
...
5. Provide `string|error` for the **Field type**, as this will be used as the return type of the resolver.
    ...
    <a href="{{base_path}}/assets/img/learn/introduction-to-inline-agents/inline-agent-step3.gif"><img src="{{base_path}}/assets/img/learn/introduction-to-inline-agents/inline-agent-create-a-graphql-resolver.gif" alt="Create a graphql resolver" width="70%"></a>
...
10. For the **Expression**, provide the `response` variable as the input.
    ...
    <a href="{{base_path}}/assets/img/learn/introduction-to-inline-agents/inline-agent-step4.gif"><img src="{{base_path}}/assets/img/learn/introduction-to-inline-agents/inline-agent-implement-resolver.gif" alt="Implement the resolving logic with an inline agent" width="70%"></a>
...
2. Query the agent by sending the mutation request below.
    ...
    <a href="{{base_path}}/assets/img/learn/introduction-to-inline-agents/inline-agent-step5.gif"><img src="{{base_path}}/assets/img/learn/introduction-to-inline-agents/inline-agent-execute.gif" alt="Run the integration to query the agent" width="70%"></a>
