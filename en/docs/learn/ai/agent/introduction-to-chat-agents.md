...
5. Click the **Create New Integration** button to generate the integration project.
    ...
    <a href="{{base_path}}/assets/img/learn/introduction-to-chat-agents/1.create-new-project.gif"><img src="{{base_path}}/assets/img/learn/introduction-to-chat-agents/1.create-new-project.gif" alt="Create a New Integration Project" width="70%"></a>
...
4. After creating the agent, you can configure it with a model provider, memory, tools, roles, and instructions.
    ...
    <a href="{{base_path}}/assets/img/learn/introduction-to-chat-agents/2.create-an-agent.gif"><img src="{{base_path}}/assets/img/learn/introduction-to-chat-agents/2.create-an-agent.gif" alt="Create an Agent" width="70%"></a>
...
3. Click **Save** to finalize and complete the agent behavior configuration.
    ...
    <a href="{{base_path}}/assets/img/learn/introduction-to-chat-agents/3.configure-behaviour.gif"><img src="{{base_path}}/assets/img/learn/introduction-to-chat-agents/3.configure-behaviour.gif" alt="Configure the Agent Behavior" width="70%"></a>
...
6. Click **Save** to complete the LLM model configuration.    
    ...
    <a href="{{base_path}}/assets/img/learn/introduction-to-chat-agents/4.configure-model.gif"><img src="{{base_path}}/assets/img/learn/introduction-to-chat-agents/4.configure-model.gif" alt="Configure the Agent Model" width="70%"></a>
...
<a href="{{base_path}}/assets/img/learn/introduction-to-chat-agents/6.add-functions.gif"><img src="{{base_path}}/assets/img/learn/introduction-to-chat-agents/6.add-functions.gif" alt="Add Tools to the Agent" width="70%"></a>
...
<a href="{{base_path}}/assets/img/learn/introduction-to-chat-agents/7.interact-with-agent.gif"><img src="{{base_path}}/assets/img/learn/introduction-to-chat-agents/7.interact-with-agent.gif" alt="Interact With the Agent" width="70%"></a>
