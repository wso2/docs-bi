...
## Step 1 - Set up BI application for observability
...
## Step 2 - Set up OpenSearch Deployment
...
Run the following `docker compose` command in the terminal to start the OpenSearch deployment along with the BI application.
