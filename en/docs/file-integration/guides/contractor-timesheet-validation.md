...
<a href="{{base_path}}/assets/img/file-integration/contractor-timesheet-validation/architecture.png">
<img src="{{base_path}}/assets/img/file-integration/contractor-timesheet-validation/architecture.png" alt="Contractor Timesheet Validation Architecture Diagram" width="90%"></a>
...
3. Select **FTP** as the protocol.
    ...
    <a href="{{base_path}}/assets/img/file-integration/contractor-timesheet-validation/2-select-ftp-integration.gif">
    <img src="{{base_path}}/assets/img/file-integration/contractor-timesheet-validation/2-select-ftp-integration.gif" alt="Select FTP Integration" width="70%"></a>
...
4. Fill in the connection properties:
    ...
    <a href="{{base_path}}/assets/img/file-integration/contractor-timesheet-validation/3-ftp-configure.gif">
    <img src="{{base_path}}/assets/img/file-integration/contractor-timesheet-validation/3-ftp-configure.gif" alt="Configure FTP Connection" width="70%"></a>
...
9. Add a **Log Info** action. In the **Msg** field, type `Processing timesheet file with ` and use the **Helper Panel** to select **Inputs** -> **content** -> `length()` and append ` records`.
    ...
    <a href="{{base_path}}/assets/img/file-integration/contractor-timesheet-validation/4-file-handler.gif">
    <img src="{{base_path}}/assets/img/file-integration/contractor-timesheet-validation/4-file-handler.gif" alt="Add File Handler" width="70%"></a>

???+ Tip "Import binds CSV to specific types"
     You can view these in the **Types** section in the left panel.

<a href="{{base_path}}/assets/img/file-integration/contractor-timesheet-validation/4-types-view.png">
<img src="{{base_path}}/assets/img/file-integration/contractor-timesheet-validation/4-types-view.png" alt="Types View" width="70%"></a>
...
5. Add a **Return** to exit early.
    ...
    <a href="{{base_path}}/assets/img/file-integration/contractor-timesheet-validation/5-record-count-validation.gif">
    <img src="{{base_path}}/assets/img/file-integration/contractor-timesheet-validation/5-record-count-validation.gif" alt="Add Record Count Validation" width="70%"></a>
...
8. Inside the **If** block, add a **Variable** action to increment the counter:
    ...
    <a href="{{base_path}}/assets/img/file-integration/contractor-timesheet-validation/6-contractor-id-validation.gif">
    <img src="{{base_path}}/assets/img/file-integration/contractor-timesheet-validation/6-contractor-id-validation.gif" alt="Add Contractor ID Validation" width="70%"></a>
...
5. Add a **Return** to exit early.
    ...
    <a href="{{base_path}}/assets/img/file-integration/contractor-timesheet-validation/7-error-threshold-check.gif">
    <img src="{{base_path}}/assets/img/file-integration/contractor-timesheet-validation/7-error-threshold-check.gif" alt="Add Error Threshold Check" width="70%"></a>
...
3. Fill in the connection properties:
    ...
    <a href="{{base_path}}/assets/img/file-integration/contractor-timesheet-validation/8-kafka-connection.gif">
    <img src="{{base_path}}/assets/img/file-integration/contractor-timesheet-validation/8-kafka-connection.gif" alt="Add Kafka Connection" width="70%"></a>
...
7. For **Value**, use the **Helper Panel** to select **record** and convert to JSON string.
    ...
    <a href="{{base_path}}/assets/img/file-integration/contractor-timesheet-validation/9-kafka-send.gif">
    <img src="{{base_path}}/assets/img/file-integration/contractor-timesheet-validation/9-kafka-send.gif" alt="Send to Kafka" width="70%"></a>
...
5. Click **+** and add a **Log Info** action. In the **Msg** field, type `Successfully processed file: ` and use the **Helper Panel** to select **Inputs** -> **fileInfo** -> **name**.
    ...
    <a href="{{base_path}}/assets/img/file-integration/contractor-timesheet-validation/10-post-processing-success.gif">
    <img src="{{base_path}}/assets/img/file-integration/contractor-timesheet-validation/10-post-processing-success.gif" alt="Add Post Processing Success" width="70%"></a>
...
7. Click **+** and add a **Log Error** action. In the **Msg** field, type `File quarantined due to error: ` and use the **Helper Panel** to select **Inputs** -> **fileInfo** -> **name**.
    ...
    <a href="{{base_path}}/assets/img/file-integration/contractor-timesheet-validation/11-post-processing-error.gif">
    <img src="{{base_path}}/assets/img/file-integration/contractor-timesheet-validation/11-post-processing-error.gif" alt="Add Post Processing Error" width="70%"></a>
