{% set tiles = [
    ...
    },
    {
        ...
        "links": [
            ...
            {"name": "Integration Service as a Managed API", "url": "integration-guides/integration-service-as-a-managed-api/how-to-expose-an-integration-service-as-a-managed-api/"},
