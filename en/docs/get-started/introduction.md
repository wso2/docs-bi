...
- **Deploy anywhere**: Ballerina Integrator supports deployment to the cloud or on-premises environment, ensuring flexibility and scalability.
    ...
    <a href="{{base_path}}/assets/img/get-started/introduction/ballerina-integrator.png"><img src="{{base_path}}/assets/img/get-started/introduction/ballerina-integrator.png" alt="Ballerina Integrator" width="90%" style="padding-top: 60px" ></a>
